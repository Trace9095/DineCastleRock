...
export const alt = 'About Dine Castle Rock - Our Mission & Story'
export const size = {
    width: 1200,
    height: 630,
}
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            The Story Behind Dine Castle Rock
                        </div>
                    </div>
                    ...
                    >
                        {['Local First', 'Community', 'Discovery', 'Quality', 'Trust'].map((value) => (
                            <div
                                key={value}
                                style={{
                                    padding: '12px 24px',
