...
export default function RootLayout({
  ...
  const content = (
    <html lang="en">
      ...
      >
        <a href="#main-content" className="sr-only focus:not-sr-only focus:absolute focus:z-[9999] focus:px-4 focus:py-2 focus:bg-white focus:text-black focus:underline">
