...
export const alt = 'Brand Assets — Dine Castle Rock'
      ...
      <div style={{ height: '100%', width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #1e293b 0%, #334155 40%, #475569 100%)', position: 'relative' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '60px', zIndex: 10 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            <div style={{ fontSize: '72px', fontWeight: 800, color: '#ffffff', letterSpacing: '-2px', marginBottom: '12px' }}>Brand Assets</div>
            <div style={{ fontSize: '30px', fontWeight: 500, color: '#cbd5e1' }}>Logos, Colors & Brand Guidelines</div>
          </div>
          <div style={{ display: 'flex', gap: '16px', marginTop: '48px' }}>
            {['Logos', 'Colors', 'Typography'].map((item) => (
              <div key={item} style={{ padding: '12px 24px', borderRadius: '100px', background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.15)', color: '#e2e8f0', fontSize: '18px', fontWeight: 500 }}>{item}</div>
            ))}
          </div>
        </div>
