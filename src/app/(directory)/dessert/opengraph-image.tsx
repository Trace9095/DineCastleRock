...
export const alt = 'Dessert & Bakery in Castle Rock - Sweet Treats & Baked Goods'
export const size = {
    width: 1200,
    height: 630,
}
        ...
        (
            ...
            >
                ...
                >
                    ...
                    >
                        {['Cupcakes', 'Cookies', 'Cakes', 'Pastries', 'Ice Cream'].map((item) => (
                            <div
                                key={item}
                                style={{
                                    padding: '12px 24px',
