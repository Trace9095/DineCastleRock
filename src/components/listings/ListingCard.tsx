    ...
    return (
        <Card className="relative overflow-hidden border-border hover:border-primary/50 transition-colors group h-full flex flex-col">
            ...
            <div className="relative aspect-[4/3] overflow-hidden bg-muted">
                ...
                {/* Placeholder Image using external URL for demo */}
                {image ? (
            ...
            <CardContent className="p-4 flex-1">
                ...
                <h3 className="font-bold text-lg leading-tight mb-2 group-hover:text-primary transition-colors line-clamp-1">
                    <Link href={`/listing/${slug}`} className="absolute inset-0 z-0">
            ...
            <CardFooter className="p-4 pt-0 mt-auto z-10 relative pointer-events-none">
                {/* Buttons need pointer-events-auto if clickable over the card link overlay, 
                or just link the whole card. For UX, card link is usually best.
                But if we want specific actions like "Book" vs "View", we need to manage z-index.
            */}
                <Button size="sm" variant="outline" className="w-full pointer-events-auto hover:bg-primary hover:text-primary-foreground transition-colors group-hover:border-primary/30">
                    View Details
                </Button>
            </CardFooter>
        </Card>
